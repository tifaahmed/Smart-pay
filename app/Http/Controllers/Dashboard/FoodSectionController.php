...
// Resource
use App\Http\Resources\Dashboard\Collections\FoodSectionCollection as ModelCollection;
use App\Http\Resources\Dashboard\FoodSection\FoodSectionResource as ModelResource;
// lInterfaces
use App\Repository\FoodSectionRepositoryInterface as ModelInterface;

// Requests
use App\Http\Requests\Api\Dashboard\FoodSection\FoodSectionStoreApiRequest as modelInsertRequest;
use App\Http\Requests\Api\Dashboard\FoodSection\FoodSectionUpdateApiRequest as modelUpdateRequest;
...
class FoodSectionController extends Controller
{
    ...
    public function __construct(ModelInterface $Repository)
    {
        ...
        $this->folder_name = 'food-section/'.date('Y-m-d-h-i-s');
