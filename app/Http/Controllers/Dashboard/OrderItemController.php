...
// Resource
use App\Http\Resources\Dashboard\Collections\OrderItemCollection as ModelCollection;
use App\Http\Resources\Dashboard\OrderItem\OrderItemResource as ModelResource;
// lInterfaces
use App\Repository\OrderItemRepositoryInterface as ModelInterface;

// Requests
use App\Http\Requests\Api\Dashboard\OrderItem\OrderItemStoreApiRequest as modelInsertRequest;
use App\Http\Requests\Api\Dashboard\OrderItem\OrderItemUpdateApiRequest as modelUpdateRequest;
...
class OrderItemController extends Controller
{
    ...
    public function __construct(ModelInterface $Repository)
    {
        ...
        $this->folder_name = 'order_item/'.date('Y-m-d-h-i-s');
        $this->file_columns = [];
