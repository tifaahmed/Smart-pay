...
// Resource
use App\Http\Resources\Dashboard\Collections\CouponCollection as ModelCollection;
...
// Requests
use App\Http\Requests\Api\Dashboard\Coupon\CouponStoreApiRequest as modelInsertRequest;
use App\Http\Requests\Api\Dashboard\Coupon\CouponUpdateApiRequest as modelUpdateRequest;
...
class CouponController extends Controller
{
    ...
    public function __construct(ModelInterface $Repository)
    {
        ...
        $this->folder_name = 'coupon/'.date('Y-m-d-h-i-s');
        $this->file_columns = [];
