    ...
    methods : {
        ...
        async tableColumns(){
            ...
            this.Columns = [
                ...
                { 
                    type: 'String'   ,header : 'start '    , name : 'start_date'     ,
                    default : null
                } ,
                { 
                    type: 'String'   ,header : 'end '    , name : 'end_date'     ,
                    default : null
                } ,
                { 
                    type: 'String'   ,header : 'month number '    , name : 'month_number'     ,
                    default : null
                } ,
                { 
                    type: 'String'   ,header : 'status'    , name : 'subscription_status'     ,
                    default : null
                } ,
                { 
                ...
                { 
                    type: 'String'   ,header : 'payment card data'    , name : 'payment_card_data'     ,
                    default : null
                } ,
                { 
