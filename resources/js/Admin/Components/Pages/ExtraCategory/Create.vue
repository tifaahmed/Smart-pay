...
<script>
import Model     from 'AdminModels/ExtraCategoryModel';
import UserModel            from 'AdminModels/UserModel';
import LanguageModel    from 'AdminModels/LanguageModel';

import DataService    from '../../DataService';

import validation     from 'AdminValidations/ExtraCategoryValidation';
import InputsFactory     from 'AdminPartials/Components/Inputs/InputsFactory.vue'     ;

    export default    {
        name:'ExtraCategory'+'Create',
        ...
        data( ) { return {
            // titles
            TableName :'ExtraCategory',
            TablePageName :'ExtraCategory.All',
