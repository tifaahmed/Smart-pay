        ...
        methods : {
            async start(){
                ...
                this.Columns = [ 
                    ...
                    { 
                        type: 'string',placeholder:null,header : 'phone_code', name : 'phone_code' ,
                        translatable : false ,
                        data_value :receivedData.phone_code  ,
                        validation:{required : true } 
                    },
                    { 
