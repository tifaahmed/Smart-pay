...
<script>
import Model     from 'AdminModels/CityModel';
import GovernmentModel     from 'AdminModels/GovernmentModel';
import LanguageModel    from 'AdminModels/LanguageModel';

import DataService    from '../../DataService';

import validation     from 'AdminValidations/CityValidation';
        ...
        methods : {
            async start(){
                ...
                this.Columns = [ 
                    ...
                    { 
                        type: 'select',placeholder:'',header :'government', name : 'government_id' ,
                        translatable : false ,
                        data_value :receivedData.government  ,  
                        validation:{required : true } ,
                        SelectOptions : this.all_governments, 
            ...
            //  Handle Data before call the server 
                HandleData(){
                    ...
                    this.SendData['government_id'] =  this.RequestData.government_id.id  ;
            ...
            // get data
                ...
                async GetlAllGovernments(){
                    this.all_governments  = ( await this.AllGovernments() ).data.data;
                },
            // get data
            ...
            // modal
                AllGovernments(){
                    return  (new GovernmentModel).all()  ;
                },
                AllLanguages(){
